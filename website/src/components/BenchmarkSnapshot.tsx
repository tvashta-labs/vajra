...
/**
 * Frozen snapshot of the benchmark comparison bars for the blog post.
 * Values are intentionally hardcoded here so this stays fixed even if the
 * home page (`Benchmarks.tsx`) numbers change later.
 */
...
export default function BenchmarkSnapshot(): React.ReactElement {
  return (
    <div className="vajra-landing mb-12 flex flex-col gap-[30px]">
      {/* vs Hugging Face */}
