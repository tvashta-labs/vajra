  ...
  return (
    <section className="py-24 px-8 md:px-24 bg-background border-t border-outline-variant/30">
      <div className="max-w-7xl mx-auto flex flex-col items-center justify-center text-center">
        ...
        <Link to="/docs/quick-start" className="px-12 py-6 bg-primary-container text-black font-black uppercase tracking-[0.3em] text-lg hover:brightness-110 transition-all active:scale-95 shadow-[0_0_15px_rgba(0,245,255,0.15)] no-underline hover:no-underline">
          Get Started Now
        </Link>
