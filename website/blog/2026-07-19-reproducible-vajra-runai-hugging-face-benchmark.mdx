...
```text
    ...
    [Dlang API] fetchS3ListObjects: body read successfully, length: 4303
    [Dlang API] fetchS3ListObjects: returning xmlStr
    ...
    [Dlang API] resolveS3Url completed
    ...
    [Dlang API] Inside runTask: dm.call finished
    [Dlang API] Inside runTask: DownloadManager error code: 0
    [Dlang API] Event loop exited
    [Python] Entering __exit__ block
    [Python] ptr=True, num=True
    [Python] Calling _lib.free_model_memory...
    [Dlang API] Thread joined, returnCode: 0
    [Dlang API] Mapping outputs...
    [Dlang API] Counting tensors...
    [Dlang API] Total tensors count: 291
    [Dlang API] Allocating CTensor array...
    [Dlang API] stream_model finished
    [Dlang API] free_model_memory entered
    ...
    [Dlang API] free_model_memory finished
```
